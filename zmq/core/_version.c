...
static char __pyx_k_2[] = "zmq.core._version";
...
static PyObject *__pyx_pf_3zmq_4core_8_version_zmq_version_info(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
...
static PyMethodDef __pyx_mdef_3zmq_4core_8_version_zmq_version_info = {__Pyx_NAMESTR("zmq_version_info"), (PyCFunction)__pyx_pf_3zmq_4core_8_version_zmq_version_info, METH_NOARGS, __Pyx_DOCSTR(__pyx_doc_3zmq_4core_8_version_zmq_version_info)};
static PyObject *__pyx_pf_3zmq_4core_8_version_zmq_version_info(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  int __pyx_v_major;
  int __pyx_v_minor;
  int __pyx_v_patch;
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__version(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_version"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_1), 0, PYTHON_API_VERSION);
  #else
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3zmq_4core_8_version_zmq_version_info, NULL, __pyx_n_s_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
